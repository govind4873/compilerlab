...
#line 144 "tree.tab.c" /* yacc.c:358  */
...
#line 1219 "tree.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 32 "tree.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]);}
#line 1225 "tree.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 33 "tree.y" /* yacc.c:1646  */
    {(yyval) = mknode((yyvsp[-2]), (yyvsp[0]), "+");}
#line 1231 "tree.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 34 "tree.y" /* yacc.c:1646  */
    {(yyval) = mknode((yyvsp[-2]), (yyvsp[0]), "-");}
#line 1237 "tree.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 36 "tree.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]);}
#line 1243 "tree.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 37 "tree.y" /* yacc.c:1646  */
    {(yyval) = mknode((yyvsp[-2]), (yyvsp[0]), "*");}
#line 1249 "tree.tab.c" /* yacc.c:1646  */
    break;
...
#line 40 "tree.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-1]);}
#line 1261 "tree.tab.c" /* yacc.c:1646  */
    break;


#line 1265 "tree.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
int main (void) 
{
        printf(" ENTER THE EXPRESSION WHICH CAN HAVE OPERATIONS ADDITION,SUBTRACTION,MULTIPLICATION AND ROUND BRACKETS:");
	return yyparse ( );
}
node *mknode(node *left, node *right, char *token)
{ /* malloc the node */
